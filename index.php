...
?>
	...
	$_SESSION['id']=$selected['sl'];
        ...
        $sl_id=$selected['sl'];
        $query = "SELECT user,cmnt FROM comments WHERE qid =$sl_id ORDER BY cid ASC";
$result = mysqli_query($con, $query);
echo "<b>Comments:</b>";
while($row = mysqli_fetch_array($result))
{
  echo "<div class=\"comment\">".$row[0]." : \"$row[1]\"</div><hr/>";
}
      ...
      <div id="#qnarea">
      <form method="post" name="cmnt-form" id="cmnt-form" action="add_comment.php">
      <textarea placeholder="Add a comment..." name="cmnt" id="cmnt"></textarea>
